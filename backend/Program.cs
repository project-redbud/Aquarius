...
static void Migrate(AquariusDbContext db)
{
    var sqls = new[]
    {
        ...
        "ALTER TABLE SiteSettings ADD COLUMN SmtpEnabled INTEGER NOT NULL DEFAULT 1",
        ...
        "ALTER TABLE Bottles ADD COLUMN IsEssence INTEGER NOT NULL DEFAULT 0",
        ...
        "ALTER TABLE Users ADD COLUMN ShowAdminUsername INTEGER NOT NULL DEFAULT 1",
    };
